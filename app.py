...
from tabs.tab_DAQ import DAQ_tab #TabDAQ
...
# -------------------------
tab_dacphysics, tab_DAQ, tab_HVramp, tab_CaenHVramp, tab_interpret, tab_analysis = st.tabs([
    "Calculator",
    "DAQ with automated HV control",
